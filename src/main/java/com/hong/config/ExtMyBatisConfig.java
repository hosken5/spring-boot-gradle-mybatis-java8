...
//        sqlSessionFactoryProperties.setProperty("vfsImpl","com.yimei.config.SpringBootExecutableJarVFS") ;
//        //添加XML目录
        ResourcePatternResolver resolver = new PathMatchingResourcePatternResolver();
        try {
            bean.setMapperLocations(resolver.getResources("classpath*:mappers/**/*.xml"));
          //bean.setTypeAliases(new Class[] {TenderDeclarationVo.class});
          ...
          //   bean.setConfigLocation(resolver.getResource("classpath:conf.xml"));
